...
-- Indexing
CREATE INDEX idx_faq_questions_user_id ON faq_questions(faq_question_user_id);
CREATE INDEX idx_faq_questions_lecture_session_id ON faq_questions(faq_question_lecture_session_id);
CREATE INDEX idx_faq_questions_lecture_id ON faq_questions(faq_question_lecture_id);
CREATE INDEX idx_faq_questions_is_answered ON faq_questions(faq_question_is_answered);
...
-- Indexing
CREATE INDEX idx_faq_answers_question_id ON faq_answers(faq_answer_question_id);
CREATE INDEX idx_faq_answers_answered_by ON faq_answers(faq_answer_answered_by);
