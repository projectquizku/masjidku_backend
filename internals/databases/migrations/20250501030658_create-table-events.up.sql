...
CREATE INDEX IF NOT EXISTS idx_event_is_public ON events(event_is_public);
CREATE INDEX IF NOT EXISTS idx_event_is_registration_required ON events(event_is_registration_required);
...
CREATE INDEX IF NOT EXISTS idx_user_event_registration_status ON user_event_registrations(user_event_registration_status);
