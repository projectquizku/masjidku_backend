CREATE TABLE lecture_sessions_quiz (
...
-- Indexing
CREATE INDEX idx_lecture_sessions_quiz_lecture_session_id ON lecture_sessions_quiz(lecture_sessions_quiz_lecture_session_id);
CREATE INDEX idx_lecture_sessions_quiz_created_at ON lecture_sessions_quiz(lecture_sessions_quiz_created_at);


  CREATE TABLE user_lecture_sessions_quiz (
  ...
  -- Indexing
  CREATE INDEX idx_user_lecture_sessions_quiz_quiz_id ON user_lecture_sessions_quiz(user_lecture_sessions_quiz_quiz_id);
  CREATE INDEX idx_user_lecture_sessions_quiz_user_id ON user_lecture_sessions_quiz(user_lecture_sessions_quiz_user_id);
  CREATE INDEX idx_user_lecture_sessions_quiz_created_at ON user_lecture_sessions_quiz(user_lecture_sessions_quiz_created_at);
