CREATE TABLE lecture_sessions_materials (
...
CREATE INDEX idx_lecture_sessions_materials_lecture_session_id ON lecture_sessions_materials(lecture_sessions_material_lecture_session_id);



CREATE TABLE lecture_sessions_assets (
...
-- Indexing
CREATE INDEX idx_lecture_sessions_assets_lecture_session_id ON lecture_sessions_assets(lecture_sessions_asset_lecture_session_id);
CREATE INDEX idx_lecture_sessions_assets_file_type ON lecture_sessions_assets(lecture_sessions_asset_file_type);
CREATE INDEX idx_lecture_sessions_assets_created_at ON lecture_sessions_assets(lecture_sessions_asset_created_at);