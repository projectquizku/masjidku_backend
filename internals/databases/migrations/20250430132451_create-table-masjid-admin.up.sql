...
CREATE INDEX idx_admins_masjid_id ON masjid_admins(masjid_admins_id);

-- Index untuk pencarian cepat admin berdasarkan user
CREATE INDEX idx_admins_user_id ON masjid_admins(masjid_admins_user_id);

-- Index gabungan jika sering query WHERE masjid_id AND is_active
CREATE INDEX idx_admins_masjid_active ON masjid_admins(masjid_admins_id, masjid_admins_is_active);
